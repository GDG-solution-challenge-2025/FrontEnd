...
class ShowModifyDialog {
  static Future<String?> showTextModifytDialog(
        ...
        return AlertDialog(
          ...
          actions: <Widget>[
            TextButton(
              ...
              onPressed: () {
                print("음식 필터링 다이얼로그 >> 삭제제");
                dialogContext.pop(null); // 다이얼로그를 닫고 아무 값도 반환하지 않음 (null 반환)
              },
            ),
            TextButton(
              ...
              onPressed: () {
                ...
                print("음식 필터링 다이얼로그 >> 수정 => $userInputText");
